...
def process_images(input_dir, output_dir, overlay_dir):
    ...
    for filename in os.listdir(input_dir):
        if filename.endswith('.png') or filename.endswith('.jpg'):
            ...
            # 히스토그램 평활화 적용
            equalized_image = apply_histogram_equalization(input_image)

            # 밝기값 분할 알고리즘 적용
            binary_mask = apply_otsu_threshold(equalized_image)
...
input_dir = '/Users/yoonchaeyeon/PycharmProjects/vision_1/input/Case_4/이미지(png)'
output_dir = '/Users/yoonchaeyeon/PycharmProjects/vision_1/output/case_4'
overlay_dir = '/Users/yoonchaeyeon/PycharmProjects/vision_1/overlay/case_4'
